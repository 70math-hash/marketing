...
**Tela 1, capa.** Foto de bancada em aula, com mão de aluno trabalhando e você ao lado apontando alguma coisa. Não é foto posada de turma. Título em Literata: "o que eu ensino em `8` horas de bancada"

**Tela 2.** Uma coisa concreta que se aprende, explicada de verdade, com o número. É a amostra da aula.
Sugestão: como calcular a temperatura da água pra fechar a massa em `24°C`, que é o conteúdo do Reels da semana `2` e sempre gera pergunta.

**Tela 3.** Uma segunda, de preferência algo que a pessoa não imagina que é importante.
Sugestão: ler ficha técnica de farinha, olhando `W` e `P/L` antes de escolher o tempo de fermentação.
...
[Abre com a coisa técnica da tela `2`, ensinada de verdade, em três ou quatro frases. É o que faz a pessoa parar, e é a prova de que a aula tem densidade.]
...
Aluno trabalhando, mão na massa, não turma posando. Vale muito uma foto do resultado do aluno e não do teu, porque prova que o método transfere.
