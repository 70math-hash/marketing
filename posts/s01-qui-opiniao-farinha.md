...
Você fala direto pra câmera, `30s`, com o saco de farinha na mão. Os primeiros `3s` já entram com a frase, sem introdução e sem cumprimento. Texto na tela reforçando `W300` e `P/L 0,55` quando você citar. Corte seco no fim, sem despedida.
