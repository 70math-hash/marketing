...
Fundo papel, texto em tinta, Verde-EVO só no disco da assinatura.

Linha de cima, pequena, em Source Sans 3: OPINIÃO IMPOPULAR
Frase central, grande, em Literata:

"Forno caro não conserta massa mal fermentada."

Rodapé: monograma MR

## Legenda

Forno caro não conserta massa mal fermentada. Ele só mostra mais rápido o que você fez errado.
...
Grava na frente do forno, com ele aceso e a boca visível. Os primeiros `3s` já entram com a frase, sem introdução.

**`0s` a `3s`:** "Forno caro não conserta massa mal fermentada."
**`3s` a `15s`:** o argumento do gás. Texto na tela: o forno expande, não cria.
**`15s` a `25s`:** a ironia do forno rápido, com uma pizza entrando e saindo em `70` segundos na tela.
**`25s` a `30s`:** os três pontos pra checar antes. Corte seco.
